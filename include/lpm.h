...
#define LPM_FILES_DIR    "/var/lib/lpm/files"   /* per-package file ownership lists */
...
void  lpm_audit(const char *fmt, ...);   /* security-sensitive actions → LPM_AUDIT_LOG */
int   confirm(const char *prompt);
int   confirm_word(const char *prompt, const char *word); /* require typing exact word */
void  init_dirs(void);
...
int   db_files_remove(const char *pkgname);  /* unlinks owned files, returns count */
